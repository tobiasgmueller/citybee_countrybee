...
A heatmap showing the pesticide findings across samples for early and late sampling. Y axis is broken up into 1. fungicide, 2. herbicides , 3. insecticide, 4. synergist
...
below is a PERMANOVA showing that there are significant differences in the pesticide composition across sites
...
```{r NMDS stressplot, include = FALSE}
...
\
\
2d NMDS, k=2, data is non transformed, stress =.08
